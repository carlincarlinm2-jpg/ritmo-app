...
const APP_URL = { ritmo: 'https://hola-ritmo.vercel.app', nutri: 'https://hola-nutri.vercel.app', lana: 'https://hola-north.vercel.app' };
const ALLOWED = ['https://hola-ritmo.vercel.app', 'https://hola-nutri.vercel.app', 'https://nutri-app-sage-sigma.vercel.app', 'https://ritmo-app-wheat.vercel.app', 'https://hola-lana.vercel.app', 'https://hola-north.vercel.app'];
const ALLOWED_RE = /^https:\/\/(lana|north)-[a-z0-9-]*\.vercel\.app$/;
